...
def _update_via_zip(args):
    ...
    branch = "main"
    zip_url = (
        f"https://github.com/sinianluoye/hermes-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/sinianluoye/hermes-agent.git",
    "git@github.com:sinianluoye/hermes-agent.git",
    "https://github.com/sinianluoye/hermes-agent",
    "git@github.com:sinianluoye/hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/sinianluoye/hermes-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from sinianluoye/hermes-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/sinianluoye/hermes-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/sinianluoye/hermes-agent.git' to add later."
            )
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    if not git_dir.exists():
        if sys.platform == "win32":
            ...
            print(
                "  curl -fsSL https://raw.githubusercontent.com/sinianluoye/hermes-agent/main/scripts/install.sh | bash"
            )
            sys.exit(1)
