...
#
# Usage:
#   irm https://raw.githubusercontent.com/sinianluoye/hermes-agent/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:sinianluoye/hermes-agent.git"
$RepoUrlHttps = "https://github.com/sinianluoye/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/sinianluoye/hermes-agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/sinianluoye/hermes-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
